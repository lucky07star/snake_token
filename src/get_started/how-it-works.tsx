    ...
    return (
        <div className="w-100 border border-5 border-black w-100 p-3" style={{ minHeight: "84vh" }}>
            <div className="d-flex justify-content-center flex-wrap fs-3 fs-lg-4 fs-xl-5 fs-xxl-6 py-2 py-lg-4">
                <div className="font-silkscreen-bold text-center" style={{ lineHeight: 'normal' }}>HOW IT WORKS:</div>
                <div className="text-center" style={{ lineHeight: 'normal' }}>TWEET TO MINE</div>
            </div>
            <div className="row px-1 pt-5 pt-lg-5 px-lg-5 px-xl-5">
                    ...
                    <div className="border border-5 border-black pt-3 pt-lg-5 box-height">
                        <div className="pt-4">
                            <div className="d-flex justify-content-center align-items-center" style={{ height: '40px' }}>
                                <h2 className="font-silkscreen-bold fs-3 fs-lg-10" style={{ lineHeight: 'normal' }}>TWEET TO EARN:</h2>
                            </div>
                ...
                <div className="col-sm-6 col-xl-3 border border-0 text-center position-relative box-margin-bottom px-3">
                    ...
                    <div className="border border-5 border-black pt-3 pt-lg-5 box-height">
                        <div className="pt-4">
                            <div className="d-flex justify-content-center align-items-center" style={{ height: '40px' }}>
                                <h2 className="font-silkscreen-bold fs-3 fs-lg-10" style={{ lineHeight: 'normal' }}>INSTANT REWARDS:</h2>
                            </div>
                            <div className="separator px-3 py-3"><div className="separator-3 separator-dashed separator-black"></div></div>
                ...
                <div className="col-sm-6 col-xl-3 border border-0 text-center position-relative box-margin-bottom px-3">
                    ...
                    <div className="border border-5 border-black pt-3 pt-lg-5 box-height">
                        <div className="pt-4">
                            <div className="d-flex justify-content-center align-items-center" style={{ height: '40px' }}>
                                <h2 className="font-silkscreen-bold fs-3 fs-lg-10" style={{ lineHeight: 'normal' }}>Deflationary & Scarce:</h2>
                            </div>
                            <div className="separator px-3 py-3"><div className="separator-3 separator-dashed separator-black"></div></div>
