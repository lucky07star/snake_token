        ...
        <div className="w-100 border border-0 w-100 p-2" style={{ minHeight: "84vh" }}>
            <div className="row px-3 pt-5 pb-0 px-lg-5 px-xl-5 pt-lg-4 pt-xl-4">
                <div className='col-md-6 d-flex justify-content-center align-items-center flex-wrap mb-4'>
                    ...
                    <a href='https://x.com/playSnakeAI' className='d-flex justify-content-start align-items-center gap-4 w-75 bg-black px-3 px-lg-5 mb-3 mb-lg-4 mb-xl-5' style={{ minHeight: '80px', textDecoration: 'none' }}>
                    ...
                    <a href='https://discord.com' className='d-flex justify-content-start align-items-center gap-4 w-75 bg-black px-3 px-lg-5 mb-3 mb-lg-4 mb-xl-5' style={{ minHeight: '80px', textDecoration: 'none' }}>
