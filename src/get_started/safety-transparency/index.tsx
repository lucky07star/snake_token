...
function SafetyTransparencyPage() {
    return (
        <div className="w-100 border border-5 border-black w-100 p-2" style={{ minHeight: "84vh" }}>
            <div className="text-uppercase text-black fs-1 fs-lg-6 fs-xl-4 fw-bolder p-3" style={{ lineHeight: 'normal' }}>Safety & Transparency</div>
            <div className="row d-flex justify-content-center align-items-center p-3 column-reverse">
                <div className="col-md-7">
                    ...
                    <div className="d-flex justify-content-start align-items-center gap-4">
                        ...
                        <span className="fs-6 fs-lg-11 fs-xl-11 fw-bolder" style={{ lineHeight: 'normal' }}>Fully audited smart contracts (by CertiK/OtterSec)</span>
                    </div>
                    <div className="px-1 py-1">
                        <hr className="border border-dashed border-black border-3 opacity-100"></hr>
                    </div>
