            ...
            <div className="d-flex justify-content-center align-items-center flex-wrap pt-lg-5 mb-1">
                <div className="row">
                    ...
                    <div className="col-xl-9 m-0 p-0">
                        <div className='position-relative w-100 border-top-0' style={{height: '75px', border: 'dashed'}}>
                            <div className='position-absolute top-0 start-0 translate-middle-x'><div style={{marginLeft: '-2px'}} className='start-50 top-0 arrow'></div></div>
                        </div>
                    </div>
